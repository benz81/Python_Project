...
'''
'add', 'clear', 'copy', 'difference''차집합', 'difference_update', 'discard', 'intersection', 'intersection_update', 
'isdisjoint', 'issubset''교집합', 'issuperset', 'pop', 'remove', 'symmetric_difference', 
